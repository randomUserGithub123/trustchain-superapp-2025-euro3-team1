...
open class EurotokenBaseFragment(contentLayoutId: Int = 0) : BaseFragment(contentLayoutId) {
    ...
    private fun getDemoModeMenuItemText(): String {
        ...
        val demoModeEnabled = pref.getBoolean(OfflineEuroMainActivity.EurotokenPreferences.DEMO_MODE_ENABLED, false)
        if (demoModeEnabled) {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            ...
            R.id.toggleDemoMode -> {
                ...
                edit.putBoolean(
                    OfflineEuroMainActivity.EurotokenPreferences.DEMO_MODE_ENABLED,
                    !sharedPreferences.getBoolean(OfflineEuroMainActivity.EurotokenPreferences.DEMO_MODE_ENABLED, false)
                )
                edit.commit()
