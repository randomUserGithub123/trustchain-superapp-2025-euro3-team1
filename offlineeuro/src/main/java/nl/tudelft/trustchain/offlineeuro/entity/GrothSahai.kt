...
object GrothSahai {
    ...
    fun createFirstStatement(
    ...
    ): Pair<GrothSahaiProof, Pair<Element, Element>> {
        ...
        return Pair(GrothSahaiProof(c1, c2, d1, d2, theta1, theta2, pi1, pi2, T), Pair(y, Y))
    }
    ...
    fun verifyProof(grothSahaiProof: GrothSahaiProof, sharedY: Element): Boolean {
        val bilinearGroup = CentralAuthority.groupDescription
        val crs = CentralAuthority.crs
    ...
    fun verifySecondStatement(grothSahaiProof: GrothSahaiProof, sharedY: Element): Boolean {
        val bilinearGroup = CentralAuthority.groupDescription
        val crs = CentralAuthority.crs
